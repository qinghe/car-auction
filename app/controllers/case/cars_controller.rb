module Case
  class CarsController < BaseController
    ...
    def permitted_params
      permitted_car_params =  params.require( :accident_car ).permit!
      # '2' is not a valid status
      if permitted_car_params.key?( 'status')
        permitted_car_params['status'] = permitted_car_params['status'].to_i
      end
      permitted_car_params
    end
  end
end
